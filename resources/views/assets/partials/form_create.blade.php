<form enctype="multipart/form-data" action="{{ route('assets.store') }}" method="post">
    ...
    <div class="box-body">
        <div class="form-group">
            ...
            <input name="name" type="text" class="form-control" id="assetName" placeholder="Naam"
                   value="{{ old('name') }}">
        </div>

        <div class="form-group">
            <label for="description">Beschrijving</label>
            <textarea name="description" type="text" class="form-control" id="description" rows="5"
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <input name="xCoordinate" type="text" class="form-control" id="xCoordinate"
                           placeholder="x-coördinaat" value="{{ old('xCoordinate') }}">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <input name="yCoordinate" type="text" class="form-control" id="yCoordinate"
                           placeholder="y-coördinaat" value="{{ old('yCoordinate') }}">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="form-group">
                    <label for="assetPicture">Foto (optioneel)</label>
