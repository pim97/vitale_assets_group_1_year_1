<form enctype="multipart/form-data" method="POST" action="{{ route('assets.update', $asset->id) }}">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <textarea name="description" id="assetDescription" class="form-control" rows="3"
                      placeholder="Toelichting van de asset...">{{ $asset->description }}</textarea>
        </div>
                ...
                <div class="form-group">
                    ...
                    <div id="map" class="map">
                        ...
                        <div class="btn-group btn-group-map">
                            ...
                            <button id="resetButton" type="button" class="btn btn-default btn-sm"><i class="fa fa-undo" aria-hidden="true"></i> Reset</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="form-group">
                    <label for="xCoordinate">X-coördinaat</label>
                    <input name="xCoordinate" type="text" class="form-control" id="xCoordinate"
                           placeholder="xCoördinaat" value="{{ $asset->x_coordinate }}">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    <label for="yCoordinate">Y-coördinaat</label>
                    <input name="yCoordinate" type="text" class="form-control" id="yCoordinate"
                           placeholder="yCoordinaat" value="{{ $asset->y_coordinate }}">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input name="threshold" type="number" step="any" class="form-control" id="threshold" placeholder="" value="{{ $asset->category->threshold }}" disabled>
            ...
            <div class="col-md-4">
                <div id="thresholdCorrectionFormGroup" class="form-group">
                    ...
                    <div class="input-group">
                        <input name="thresholdCorrection" type="number" step="any" class="form-control" id="thresholdCorrection" placeholder="Drempelwaarde correctie" value="{{ $asset->threshold_correction }}">
                        <span class="input-group-addon">m</span>
                    </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input name="thresholdReal" type="number" step="any" class="form-control" id="thresholdReal" placeholder="" value="@if($asset->threshold_real){{$asset->threshold_real}}@else{{''}}@endif" disabled>
                        <span class="input-group-addon">m</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="form-group" id="photo">
                    @if($assetPic)
                        ...
                        <br>
                        <a onclick="deletePic()" class="btn btn-danger btn-sm" style="margin-top: 5px;"><i class="fa fa-trash" aria-hidden="true"></i> Verwijder foto</a>
                    @endif
